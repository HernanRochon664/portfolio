...
const sectionHeading =
  "text-xs uppercase tracking-widest text-muted-foreground border-b border-border pb-1 mb-3 print:mb-1.5"
...
export default async function ResumePage({
  ...
  return (
    <div className="mx-auto max-w-2xl px-8 py-12 print:max-w-none print:px-0 print:py-0">
      <div className="mb-8 flex justify-end print:hidden">
        <PrintButton label={dict.download} />
      </div>

      <header className="mb-10 flex items-center gap-5 print:mb-4 print:gap-4">
        <Image
        ...
        <div className="min-w-0">
          <h1 className="text-3xl font-bold tracking-tight print:text-[17pt] print:leading-tight">
            Hernan Rochon
          </h1>
          <p className="mt-1 text-muted-foreground print:mt-0 print:text-[10pt]">
            {dict.role}
          </p>
          <div className="mt-3 flex flex-col font-mono text-xs leading-relaxed text-muted-foreground print:mt-1 print:text-[7.5pt] print:leading-snug">
        ...
        <div className="flex flex-col gap-5 print:gap-1.5">
          {dict.projects.map((project) => (
            <div key={project.title}>
              ...
              <ul className="mt-1.5 ml-5 list-disc space-y-1 text-sm text-foreground/90 marker:text-muted-foreground print:mt-1 print:space-y-0">
      ...
      <section className="mb-8 print:mb-2.5">
        ...
        <div className="flex flex-col gap-1.5 text-sm print:grid print:grid-cols-2 print:gap-x-8 print:gap-y-0.5">
      ...
      <section className="mb-8 print:mb-2.5">
        ...
        <ul className="ml-5 list-disc space-y-1 text-sm text-foreground/90 marker:text-muted-foreground print:space-y-0">
      ...
      <div className="print:grid print:grid-cols-2 print:gap-8">
        <section className="mb-8 print:mb-0">
          ...
          <p className="text-sm text-foreground/90">{dict.education}</p>
        </section>

        <section>
          <h2 className={sectionHeading}>{dict.sections.languages}</h2>
          <ul className="flex flex-col gap-1 text-sm text-foreground/90 print:gap-0">
